...
| **[On the Complexity of Bilevel Linear and Quadratic Programs in Fixed Dimensions](https://arxiv.org/abs/2511.15592v2)** | 2026-06-10 | <details><summary>The e...</summary><p>The extended manuscript completes the complexity classification of bilevel linear programs (BLPs) in fixed dimensions and investigates whether the polynomial-time solvability results obtained for BLPs persist for bilevel quadratic programs (BQPs)</p></details> |
| **[Remotely programming the weights of a spintronic neural network by a radiofrequency broadcast signal](https://arxiv.org/abs/2604.24561v3)** | 2026-06-10 | 8 pages, 3 figures |
